...
from .datasets import airplane #lm_syn_imgn, lm_dataset_d2, lm_pbr, lm_blender, ycbv_pbr, ycbv_d2, ycbv_bop_test, 


cur_dir = osp.dirname(osp.abspath(__file__))
# from lib.utils.utils import iprint
__all__ = ["register_dataset", "register_datasets", "register_datasets_in_cfg", "get_available_datasets"]
_DSET_MOD_NAMES = ["airplane"] # "lm_syn_imgn", "lm_dataset_d2", "lm_pbr", "lm_blender", "ycbv_pbr", "ycbv_d2", "ycbv_bop_test", 
